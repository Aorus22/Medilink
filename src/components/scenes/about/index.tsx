      ...
      <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.About)}>
        ...
        >
          <div className="md:w-full">
            <HText>What is PharmaSwift?</HText>
            <p className="py-5">
              PharmaSwift is an innovative prototype based on the Internet of
              ...
              information. PharmaSwift aims to improve healthcare service
