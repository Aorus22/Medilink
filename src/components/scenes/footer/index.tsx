  ...
  return (
    <footer className="bg-teal-400">
      <div className="justify-content mx-auto gap-16 md:flex px-16 pt-12">
        <div className="flex-1 w-full">
          <div className="flex flex-col w-auto">
            <div>
              <img alt="logo" src={"/assets/Logo/pharmashift.png"} className="h-10 w-13" />
              <p className="font-montserrat block text-xl font-bold">
                PharmaSwift
              </p>
            </div>
            <p className="my-5 max-w-[100%][3000px]">
              Our research successfully developed PharmaSwift, an Internet of medical things (IoMT) system that integrates MPX5050DP
      ...
      <div className="px-16 pb-10">
        <p>© PharmaSwift All Rights Reserved.</p>
