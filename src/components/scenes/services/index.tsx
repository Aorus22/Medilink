...
const services: Array<BenefitType> = [
  {
    ...
    desc: "SDG 3 aims to ensure healthy lives and promote well-being for all at all ages. This includes access to quality healthcare services, reducing mortality from infectious diseases, and providing rapid responses to medical conditions. PharmaSwift Smart supports SDG 3 by offering an IoT-based system that enables real-time health monitoring. With MPX and MLX sensor technology integrated with a server, PharmaSwift Smart facilitates accurate medical information access and helps improve the efficiency of healthcare services.",
  },
  {
    icon: <img src={sdg9} className="h-40 w-40" />,
    title: "Industry, Innovation, and Infrastructure",
    desc: "SDG 9 highlights the importance of building resilient infrastructure, fostering innovation, and promoting sustainable industrialization. PharmaSwift Smart contributes to this goal by utilizing IoT technology and developing innovative devices relevant to the healthcare sector. This system not only improves the efficiency of health monitoring but also encourages cross-sector collaboration between technology and healthcare services",
  },
  {
    icon: <img src={sdg16} className="h-40 w-40" />,
    title: "Peace, Justice, and Strong Institutions",
    desc: "SDG 16 aims to promote strong institutions, transparency, and justice for all. By enabling real-time health data monitoring, PharmaSwift Smart enhances transparency in medical information management and supports data-driven decision-making. This project can contribute to a fairer healthcare system by providing equal access to medical technology, particularly for underserved communities.",
  },
  {
    icon: <img src={sdg17} className="h-40 w-40" />,
    title: "Partnerships for the Goals",
    desc: "SDG 17 emphasizes the importance of global partnerships to support the achievement of sustainable development goals. PharmaSwift Smart aligns with this goal by creating opportunities for collaboration among technology developers, healthcare providers, universities, and governments. The synergy of these stakeholders in the development and implementation of PharmaSwift Smart can accelerate the adoption of IoT-based solutions in healthcare, expand access to this technology, and strengthen global healthcare systems.",
  },
];
      ...
      <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.Services)}>
        ...
        >
          ...
          <p className="my-5 text-sm">
            PharmaSwift Smart Can Support Sustainable Development Goals (SDGs)
          </p>
        </motion.div>
        ...
        {/* About PharmaSwift Smart Section */}
        <div className="mt-20 flex flex-col-reverse md:flex-row items-center gap-10">
          ...
          <div>
            ...
            >
              <HText>
                ABOUT PHARMASWIFT <span className="text-primary-300"></span>
              </HText>
              <p className="my-4">
                We created PharmaSwift Smart to address the challenges of improving
                healthcare efficiency through real-time monitoring of patient
                vital signs, reducing manual errors, and expanding access to
                remote areas.
              </p>
              <p>
                PharmaSwift Smart is the result of interdisciplinary collaboration
